...
export default function Main() {
  ...
  initial={{ x: -200, scale: 0.3, opacity: 0 }}     // Слева и маленькая
  animate={{ x: 0, scale: 1, opacity: 1 }}          // Переход в исходное положение
  transition={{
   type: 'spring',
            stiffness: 30,
            damping: 20,
...
/>
  ...
  initial={{ x: -200, opacity: 0 }}  // Начальная позиция слева на 200px, невидима
  animate={{ x: 0, opacity: 1 }}     // Позиция по центру (или где нужно) и полная видимость
  transition={{
    delay: 1.5,          // Задержка в 3 секунды перед началом анимации
    duration: 1.0,     // Время анимации (можно настроить)
    ease: "easeOut",   // Плавная анимация
  }}
/>
